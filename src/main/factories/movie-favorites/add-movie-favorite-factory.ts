...
import { AddOneMovieFavoriteController } from "src/adapters/presentation/controllers/movie-favorites";
...
export function makeAddOneMovieFavoriteFactory(): BaseController {
  ...
  const addOneMovieFavoriteController = new AddOneMovieFavoriteController(movieFavoritesUseCases);
